![](attachments/4f099a5f88b80ab2d272c5def075db82.png)

In a previous post, we looked at the[ 4 Prioritization Jobs (And Why It Matters)](https://cutlefish.substack.com/p/tbm-351-the-4-prioritization-jobs?utm_source=activity_item). This post is more broadly about frameworks and framework jobs.
...
1. Some people eschew frameworks as being too "process-driven," believing that team members should already have the skills and that frameworks are a "crutch" for the inexperienced.

2. Others view people as individually competent and simply need a lightweight interface to work better together.

3. Still, others want to mandate a global process without appreciating the need for local independence. In these cases, the goal often drifts from using the framework as a tool to using it as an end in itself.
...
2. Have you seen a framework get operationalized into a rigid process when it was originally intended as a thinking tool? What happened as a result?

3. How do different people in your organization define "experience"? How does that shape their view of whether frameworks are necessary or a "crutch"?
...
7. Have you ever watched a team shift from "using a framework as a tool" to "doing the framework for its own sake"? What caused that shift?
...
9. Have you seen leaders misjudge whether a team needs a scaffold for collective learning versus simply a shared language for coordination? What were the consequences?
