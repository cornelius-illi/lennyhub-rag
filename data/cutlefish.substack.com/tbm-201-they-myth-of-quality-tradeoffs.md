![](attachments/7e91e467fae147f018e23a92ef0fa6ee.png)

*Note: I slipped in [a weekend post](https://cutlefish.substack.com/p/tbm-200-product-team-enabling-team) on Product Team / Enabling Team Collaboration. Back to my Thursday cadence…*
...
1. **Learned the hard way**. Unless you've seen something go entirely to shit, you are unlikely to understand, on a deep level, how bad things could get (and how quickly they could get worse)

2. **Long-view and patience**. [Writes Robert Lippert](https://twitter.com/robsblog/status/1628527765275217920?s=20): "To me, quality is being able to ship and iterate on an item later. That way, I can deliver fast and make sure that quality will improve over time if needed. I think the most limiting factor to that perspective is patience." I love this quote because it suggests that a quality *approach can* make learning easier and increase quality. 

3. **Shared understanding**. [Writes Mark Noonan](https://twitter.com/marktnoonan/status/1628520543660961798?s=20): "If an org hasn't explicitly defined quality, it can be traded away invisibly. Every unit of work always "hits the bar" for a set of reviewers, but quality as a whole becomes uneven without any deliberate decision or awareness. So having a definition is a factor." As we learned above, this shared understanding will necessarily overlap questions about value and customers.

4. **Skills**. Working small, not bikeshedding, considering extensibility (without obsessing over it), focusing on thin slices, etc., takes skill. Working in the way that Robert Lippert describes above takes skill (as well as patience).

5. **They make high quality "cheaper"**. Some companies make achieving higher quality *cheaper* than other companies—the same level of quality, much less overhead. For example, a good design system makes doing the right thing *easier*. The right organizational design and architecture allow teams to spend more time on quality work and less time juggling dependencies and processes.

6. **Leadership's core beliefs**. If leaders believe that quality and innovation are a tradeoff, then there's little the team can do. If they've learned the hard way (perhaps), then even when they run things a bit fast and loose, they'll listen when someone raises the flag.
