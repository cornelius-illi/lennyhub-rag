...
1. **Flow**. Someone would point out, "We can't even get to the bottom of the list—our pipes are clogged.

2. **Leverage**. Others would challenge the list: "Are we even sure this is the right list? Is it strategically aligned?"

3. **Autonomy and resolution**. And always, always: "Did you pitch outcomes or projects?"—with blurry assumptions and tradeoffs hidden beneath the surface.

4. **Funding**. A leader might say, "Oh, you want that item this year? Then we'll need to revisit the budget."
...
![](attachments/0b5a1677d1f04a4d2476469360efca71.png)
